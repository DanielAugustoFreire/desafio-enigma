...
router.post("/decrypt", auth.autenticarUsuario, (req, res) => {
    // #swagger.tags = ['Key']
...
router.get("/current-key", auth.autenticarUsuario, (req, res) => {
    // #swagger.tags = ['Key']
...
router.get("/keys", auth.autenticarUsuarioMestre, (req, res) => {
    // #swagger.tags = ['Key']
